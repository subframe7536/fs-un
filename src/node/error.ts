...
export function isNotExistsError(err: any) {
  return err.code === 'ENOENT'
}

export function isAnotherDeviceError(err: any) {
  return err.code === 'EXDEV'
}

export function isDirError(err: any) {
  return err.code === 'EISDIR'
}

export function notDirError(err: any) {
  return err.code === 'ENOTDIR'
}

export function isNoPermissionError(err: any) {
  return err.code === 'EACCES' || err.code === 'EPERM'
}

export function isAlreadyExistError(err: any) {
  return err.code === 'EEXIST'
}

export function handleRestError(err: any, fn: string, path: string, path2?: string) {
